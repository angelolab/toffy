...
class RunCallbacks:
    ...
    def plot_mph_metrics(self, mph_output_dir, regression, out_dir, **kwargs):
        ...
        visualize_mph(mph_df, regression, out_dir)
...
class FovCallbacks:
    ...
    def generate_mph(self, mph_output_dir, input_mass, input_mass_start, input_mass_stop,
        ...
        if not os.path.exists(mph_output_dir):
            os.mkdir(mph_output_dir)
