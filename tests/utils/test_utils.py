...
class RunStructureCases:
    ...
    def case_new_format_old_scan_key(self):
        """Two FOVs using the new rois-nested run file format with legacy scanCount key."""
        fov_count = 2
        run_json = {
    ...
    def case_old_format_old_scan_key(self):
        """Two FOVs using the legacy root-level fovs format with legacy scanCount key."""
        fov_count = 2
