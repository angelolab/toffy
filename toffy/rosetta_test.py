...
def test_create_rosetta_matrices():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        test_channels = [23, 48, 56, 69, 71, 89, 113, 115, 117, 141, 142, 143, 144, 145, 146]
        test_channels += [147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160]
        test_channels += [161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172]
        test_channels += [173, 174, 175, 176, 181, 197]
        ...
        validation = (test_matrix_2.iloc[test_index, :] / multipliers[0]).astype(int)
        # row of random matrix at channel
        random_matrix_channel = random_matrix.iloc[test_index]
        ...
        for i in test_channels:
            if i not in channels:
                ...
                assert np.array_equal(test_matrix_2.iloc[channel_index, :],
                                      random_matrix.iloc[channel_index, :])
