...
necessary_masses = pd.DataFrame({
    'Mass': [39, 48, 56, 69, 71, 89, 113, 115, 117, 141, 142, 143, 144, 145, 146, 147, 148, 149,
             ...
             167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 197],
    'Target': ['chan_39', 'chan_48', 'Fe', 'chan_69', 'chan_71', 'chan_89', 'chan_113', 'chan_115',
               'Noodle', 'chan_141', 'chan_142', 'chan_143', 'chan_144', 'chan_145', 'chan_146',
               'chan_147', 'chan_148', 'chan_149', 'chan_150', 'chan_151', 'chan_152', 'chan_153',
               'chan_154', 'chan_155', 'chan_156', 'chan_157', 'chan_158', 'chan_159', 'chan_160',
               'chan_161', 'chan_162', 'chan_163', 'chan_164', 'chan_165', 'chan_166', 'chan_167',
               'chan_168', 'chan_169', 'chan_170', 'chan_171', 'chan_172', 'chan_173', 'chan_174',
...
def convert_panel(panel_path):
    ...
    print(f'{panel_name}.csv does not have the correct toffy format. '
